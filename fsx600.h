...
struct fs_super {
    ...
    uint32_t fold_case: 1;      /** 1 if fold case, 0 if preserve case  */
    uint32_t ignore_case : 1;   /** 1 if case-independent, 0 if case-dependent */
    uint32_t root_inode: 30;	/** always inode 1 */
